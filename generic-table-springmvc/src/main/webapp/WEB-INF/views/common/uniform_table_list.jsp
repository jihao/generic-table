...
<%@ page import="com.haojii.generic.table.model.cells.HeaderCell"%>
<%@ page import="com.haojii.generic.table.model.cells.IconLinksCell"%>
<%@ page import="com.haojii.generic.table.model.cells.CheckboxCell"%>
<%@ page import="com.haojii.generic.table.model.cells.TableCell"%>
...
<form name="uniformTableForm" method="GET">
	<input type="hidden" id="sortedColumnName" name="sortedColumnName" value="${sortedColumnName}">
	<input type="hidden" id="sortOrderAscending" name="sortOrderAscending" value="${sortOrderAscending}">
	...
	<c:forEach var="header" items="${tableModel.headerCellList}"> 
		...
		<input type="hidden" id="filter_${fieldName}" name="filter(${fieldName})" >
		<% } %> 
	</c:forEach> 
</form>
